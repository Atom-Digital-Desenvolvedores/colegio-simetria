		...
		<div class="wsg-posts">
			...
			<?php $itens = 0; while ( $r->have_posts() ) : $r->the_post();
				...
				?>
					...
					<div class="wsg-ultimos-posts">
						<figure>
							<?php getImageThumb($attachID, '180x180'); ?>
						</figure>
						<div>
							<h4><a href="<?php the_permalink(); ?>"><?php get_the_title() ? the_title() : the_ID(); ?></a></h4>
							<span class="wq-data">
								<?php echo get_the_date('d', $item->ID); ?> de <?php echo get_the_date('F', $item->ID); ?> de <?php echo get_the_date('Y', $item->ID); ?>
							</span>
						</div>
					</div>
