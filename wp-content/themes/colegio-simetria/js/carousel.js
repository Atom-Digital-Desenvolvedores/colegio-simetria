$(document).ready(function() {
	$('.wsg-banner-conteudo-carousel,.wq-cores-de-fundo,.wsg-carousel-banner').slick({
		dots: false,
		arrows:false,
		infinite: true,
		speed: 500,
		fade: true,
		cssEase: 'linear',
		asNavFor: '.wsg-btns-carousel'
	});
	$('.wsg-btns-carousel').slick({
		slidesToShow: 3,
		slidesToScroll: 1,
		asNavFor: '.wsg-banner-conteudo-carousel,.wq-cores-de-fundo,.wsg-carousel-banner',
		dots: false,
		arrows:false,
		focusOnSelect: true
	  });
	$(".wq-sobre-carousel").owlCarousel({
		items:1,
		loop:true,
		nav: false,
		autoplay:true,
